...
ax.annotate('See how the curve',color='#ff7f0e',wrap= True, xy=(7,1),xytext=(3,1.3))
ax.annotate('levels off at u =1',color='#ff7f0e',wrap= True,xy=(7,1),xytext=(3,1.2),arrowprops =dict(facecolor='black', shrink =0.04))
...
def CatchtheFisherwaveanimate(n):
    ...
    ax.fill_between(x,un,8,interpolate=True, color='white')
